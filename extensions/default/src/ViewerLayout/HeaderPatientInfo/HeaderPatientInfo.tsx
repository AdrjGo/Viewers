...
function HeaderPatientInfo({ servicesManager, appConfig }: withAppTypes) {
  ...
  return (
    <div
      className="hover:bg-primary-dark flex cursor-pointer items-center justify-center gap-1 rounded-lg max-sm:hidden"
      ...
      <div className="flex flex-col justify-center">
        {expanded === false ? (
          <>
            ...
            <div className="text-aqua-pale flex gap-2 text-[10px] text-[11px]">
          ...
          <div className="text-primary self-center text-[13px]">
            {isMixedPatients ? 'Multiple Patients' : 'Paciente'}
          </div>
        )}
      </div>
